class Title extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('witch1', 'img/clotho.jpg')
        this.load.image('witch2', 'img/lachesis.jpg')
        this.load.image('witch3', 'img/atropos.jpg')
        this.load.image('all', 'img/All_fates.jpg')
